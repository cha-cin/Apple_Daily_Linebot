...
weather_tomorrow_situation_gif = ""
...
def search(new_url):
    ...
    global weather_tomorrow_situation_gif
    ...
    weather_situation_gif = soup.findAll(id='box8')[0].findAll('tr')[1].findAll('td')[1].findAll('img')[0].get('src')
    weather_situation_gif = "https://www.cwb.gov.tw/V7"+weather_situation_gif[5:]
    weather_feel  = soup.findAll(id='box8')[0].findAll('tr')[1].findAll('td')[2].string
    weather_rain  = soup.findAll(id='box8')[0].findAll('tr')[1].findAll('td')[3].string
    ...
    weather_tonight_situation_gif = soup.findAll(id='box8')[0].findAll('tr')[2].findAll('td')[1].findAll('img')[0].get('src')
    weather_tonight_situation_gif = "https://www.cwb.gov.tw/V7"+weather_situation_gif[5:]
    weather_tonight_feel  = soup.findAll(id='box8')[0].findAll('tr')[2].findAll('td')[2].string
    weather_tonight_rain  = soup.findAll(id='box8')[0].findAll('tr')[2].findAll('td')[3].string
    ...
    weather_tomorrow_situation_gif = soup.findAll(id='box8')[0].findAll('tr')[3].findAll('td')[1].findAll('img')[0].get('src')
    weather_tomorrow_situation_gif = "https://www.cwb.gov.tw/V7"+weather_situation_gif[5:]
    weather_tomorrow_feel  = soup.findAll(id='box8')[0].findAll('tr')[3].findAll('td')[2].string
    weather_tomorrow_rain  = soup.findAll(id='box8')[0].findAll('tr')[3].findAll('td')[3].string
